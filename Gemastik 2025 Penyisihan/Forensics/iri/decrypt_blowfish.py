...
def read_encrypted_file(filename):
    ...
    print(
        f"Encrypted data (hex): {encrypted_data[:96+64+64+64+64+64+64+64+64+64+64+64+64+64+64+64+64+64+64+64]}"
    )
...
if __name__ == "__main__":
    ...
    encrypted_data = read_encrypted_file("http_objs/upload%3ffilename=script.py.enc")
