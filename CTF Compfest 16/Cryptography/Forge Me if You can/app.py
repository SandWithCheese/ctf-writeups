...
def rsa_verify(signature, public_key, n, original_message):
    print(bytes_to_long(icb_256(original_message)))
    print(pow(bytes_to_long(signature), public_key, n))
    print(pow(bytes_to_long(icb_256(original_message)), public_key, n))
    return pow(bytes_to_long(signature), public_key, n) == bytes_to_long(
        icb_256(original_message)
    )
