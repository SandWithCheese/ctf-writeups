...
_sage_const_0 = Integer(0); _sage_const_16 = Integer(16); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_8 = Integer(8)
import base64
...
with open("output.txt", "r") as f:
    p = f.readline().strip().split(" = ")[_sage_const_1 ]
    g = f.readline().strip().split(" = ")[_sage_const_1 ]
    A = f.readline().strip().split(" = ")[_sage_const_1 ]
    B = f.readline().strip().split(" = ")[_sage_const_1 ]
...
A = int(A, _sage_const_2 )
print(A)

B = int(B, _sage_const_8 )
print(B)
...
key = hash.digest()[:_sage_const_16 ]
